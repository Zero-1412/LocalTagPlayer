...
## 2026-07-21 CURRENT_TASK 活跃区 / 历史区拆分观察

- `CURRENT_TASK.md` 从 1,017 行、82,073 字符收敛为 54 行、2,135 字符；旧记录无损迁入 `docs/task_history/CURRENT_TASK_HISTORY_THROUGH_2026-07-19.md`，且新任务默认不读取归档。
- `reg-level2-validation-coverage` 使用与 2026-07-19 相同的 `gpt-5.6-terra`、`reasoning_effort=low`、workspace snapshot 和 N=5 条件复跑：5/5、平均 100 分、`stable=true`，零基础设施错误和零隔离文件改动。
