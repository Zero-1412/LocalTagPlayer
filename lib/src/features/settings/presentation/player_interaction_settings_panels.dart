...
class FullscreenQueueSettingsCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Semantics(
      ...
      label: '全屏播放列表工作区',
      child: Material(
        key: const ValueKey('settings.fullscreenQueue.workspaceSurface'),
        color: librarySurface,
        shape: _settingsWorkspaceShape,
        child: Padding(
...
class PlayerShortcutsSettingsCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Semantics(
      key: const ValueKey('settings.shortcuts.card'),
      container: true,
      label: '播放器快捷键工作区',
      child: Material(
        key: const ValueKey('settings.shortcuts.workspaceSurface'),
        color: librarySurface,
        shape: _settingsWorkspaceShape,
        child: Padding(
          padding: const EdgeInsets.all(18),
...
const _settingsWorkspaceShape = RoundedRectangleBorder(
